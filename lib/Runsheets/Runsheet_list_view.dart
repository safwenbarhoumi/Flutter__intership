import 'package:best_flutter_ui_templates/Runsheets/runsheet_home_screen.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';

class RunsheetsListView extends StatelessWidget {
  final VoidCallback callback;
  final RunsheetsListData hotelData;
  final Animation<double> animation;
  final AnimationController animationController;

  const RunsheetsListView({
    Key? key,
